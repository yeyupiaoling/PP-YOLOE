...
if __name__ == '__main__':
    ...
    parser.add_argument("--image_file",  type=str,   default='dataset/images/1590392775029.jpg', help="Path of image file.")
    ...
    # 执行预测获取结果
    result = predict_image(args.image_file)
    print('预测结果：%s' % result)
    # 画框
    draw_image(args.image_file, result['boxes'])
    cv2.waitKey(0)
